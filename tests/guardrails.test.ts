// Automated Verification Test Suite (Section XLIX)
import assert from 'node:assert';
import { abbreviateVietnameseName, maskLicensePlate, reviewArticlePrivacy } from '../src/lib/guardrails/privacy';
import { factCheckArticleWithSource } from '../src/lib/guardrails/fact-checker';
import { reviewAccidentContent } from '../src/lib/guardrails/accident';
import { reviewUnitNames } from '../src/lib/guardrails/unit-name';
import { SourceData } from '../src/lib/store/types';
